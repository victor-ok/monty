...
void monty_add(stack_t **stack, unsigned int line_number)
{
	...
	{
		op_tok_error(short_stack_error(line_number, "add"));
		return;
	}
...
void monty_sub(stack_t **stack, unsigned int line_number)
{
	if ((*stack)->next == NULL || (*stack)->next->next == NULL)
	{
		op_tok_error(short_stack_error(line_number, "sub"));
		return;
	}
...
void monty_div(stack_t **stack, unsigned int line_number)
{
	if ((*stack)->next == NULL || (*stack)->next->next == NULL)
	{
		op_tok_error(short_stack_error(line_number, "div"));
		return;
	}
...
void monty_mul(stack_t **stack, unsigned int line_number)
{
	if ((*stack)->next == NULL || (*stack)->next->next == NULL)
	{
		op_tok_error(short_stack_error(line_number, "mul"));
		return;
	}
...
void monty_mod(stack_t **stack, unsigned int line_number)
{
	if ((*stack)->next == NULL || (*stack)->next->next == NULL)
	{
		op_tok_error(short_stack_error(line_number, "mod"));
		return;
	}
